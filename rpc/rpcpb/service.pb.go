...
func (m *GetMasterAccountRequest) Reset()                    { *m = GetMasterAccountRequest{} }
func (m *GetMasterAccountRequest) String() string            { return proto.CompactTextString(m) }
func (*GetMasterAccountRequest) ProtoMessage()               {}
func (*GetMasterAccountRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }

func (m *GetMasterAccountRequest) GetNetworkID() string {
	if m != nil {
		return m.NetworkID
	}
	return ""
...
func (m *GetMasterAccountResponse) Reset()                    { *m = GetMasterAccountResponse{} }
func (m *GetMasterAccountResponse) String() string            { return proto.CompactTextString(m) }
func (*GetMasterAccountResponse) ProtoMessage()               {}
func (*GetMasterAccountResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{8} }

func (m *GetMasterAccountResponse) GetData() []byte {
	if m != nil {
		return m.Data
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*GetMasterAccountRequest)(nil), "rpcpb.GetMasterAccountRequest")
	proto.RegisterType((*GetMasterAccountResponse)(nil), "rpcpb.GetMasterAccountResponse")
...
type NodeClient interface {
	// GetMasterAccount allows the client to get the master account of the network,
	// the main purpose of the method is for creating test accounts for testnet.
	GetMasterAccount(ctx context.Context, in *GetMasterAccountRequest, opts ...grpc.CallOption) (*GetMasterAccountResponse, error)
...
func (c *nodeClient) GetMasterAccount(ctx context.Context, in *GetMasterAccountRequest, opts ...grpc.CallOption) (*GetMasterAccountResponse, error) {
	out := new(GetMasterAccountResponse)
	err := grpc.Invoke(ctx, "/rpcpb.Node/GetMasterAccount", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NodeServer interface {
	// GetMasterAccount allows the client to get the master account of the network,
	// the main purpose of the method is for creating test accounts for testnet.
	GetMasterAccount(context.Context, *GetMasterAccountRequest) (*GetMasterAccountResponse, error)
	// GetAccount allows the client to get the account information of an account.
...
func _Node_GetMasterAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetMasterAccountRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NodeServer).GetMasterAccount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rpcpb.Node/GetMasterAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NodeServer).GetMasterAccount(ctx, req.(*GetMasterAccountRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Node_GetMasterAccount_Handler,
		},
		{
...
var fileDescriptor0 = []byte{
	...
	,
}
